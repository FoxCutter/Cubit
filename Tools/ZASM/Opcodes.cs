    ...
    static class Ops
    {
        static public OpcodeEncoding[] EncodingData = new OpcodeEncoding[]
        {
            ...
            new OpcodeEncoding { Name = "ADD",	// 9: ADD HL BC
                                  ...
                                  Reg1 = CommandID.HX, Reg1Param = RegParam.WordData,
                                  Reg2 = CommandID.BC, Reg2Param = RegParam.WordData,
                                  Function = CommandID.ADD },
            ...
            new OpcodeEncoding { Name = "ADD",	// 29: ADD HL HL
                                  ...
                                  Reg1 = CommandID.HX, Reg1Param = RegParam.WordData,
                                  Reg2 = CommandID.HX, Reg2Param = RegParam.WordData,
                                  Function = CommandID.ADD },
            ...
            new OpcodeEncoding { Name = "AND",	// A6: AND (HL) 
                                  ...
                                  Reg1 = CommandID.HD, Reg1Param = RegParam.Reference,
                                  Reg2 = CommandID.None, Reg2Param = RegParam.None,
            ...
            new OpcodeEncoding { Name = "BIT",	// CB4E: BIT 1 (HL)
                                  ...
                                  Reg1 = (CommandID)1, Reg1Param = RegParam.Literal,
                                  Reg2 = CommandID.HD, Reg2Param = RegParam.Reference,
                                  Function = CommandID.BIT },
            ...
            new OpcodeEncoding { Name = "BIT",	// CB56: BIT 2 (HL)
                                  ...
                                  Reg1 = (CommandID)2, Reg1Param = RegParam.Literal,
                                  Reg2 = CommandID.HD, Reg2Param = RegParam.Reference,
                                  Function = CommandID.BIT },
            ...
            new OpcodeEncoding { Name = "BIT",	// CB5E: BIT 3 (HL)
                                  ...
                                  Reg1 = (CommandID)3, Reg1Param = RegParam.Literal,
                                  Reg2 = CommandID.HD, Reg2Param = RegParam.Reference,
                                  Function = CommandID.BIT },
            ...
            new OpcodeEncoding { Name = "BIT",	// CB66: BIT 4 (HL)
                                  ...
                                  Reg1 = (CommandID)4, Reg1Param = RegParam.Literal,
                                  Reg2 = CommandID.HD, Reg2Param = RegParam.Reference,
                                  Function = CommandID.BIT },
            ...
            new OpcodeEncoding { Name = "BIT",	// CB6E: BIT 5 (HL)
                                  ...
                                  Reg1 = (CommandID)5, Reg1Param = RegParam.Literal,
                                  Reg2 = CommandID.HD, Reg2Param = RegParam.Reference,
                                  Function = CommandID.BIT },
            ...
            new OpcodeEncoding { Name = "BIT",	// CB76: BIT 6 (HL)
                                  ...
                                  Reg1 = (CommandID)6, Reg1Param = RegParam.Literal,
                                  Reg2 = CommandID.HD, Reg2Param = RegParam.Reference,
                                  Function = CommandID.BIT },
            ...
            new OpcodeEncoding { Name = "BIT",	// CB7E: BIT 7 (HL)
                                  ...
                                  Reg1 = (CommandID)7, Reg1Param = RegParam.Literal,
                                  Reg2 = CommandID.HD, Reg2Param = RegParam.Reference,
                                  Function = CommandID.BIT },
            ...
            new OpcodeEncoding { Name = "DEC",	// 0B: DEC BC 
                                  ...
                                  Reg1 = CommandID.BC, Reg1Param = RegParam.WordData,
                                  Reg2 = CommandID.None, Reg2Param = RegParam.None,
                                  Function = CommandID.DEC },
            ...
            new OpcodeEncoding { Name = "DEC",	// 1B: DEC DE 
                                  ...
                                  Reg1 = CommandID.DE, Reg1Param = RegParam.WordData,
                                  Reg2 = CommandID.None, Reg2Param = RegParam.None,
                                  Function = CommandID.DEC },
            ...
            new OpcodeEncoding { Name = "DEC",	// 3B: DEC SP 
                                  ...
                                  Reg1 = CommandID.SP, Reg1Param = RegParam.WordData,
                                  Reg2 = CommandID.None, Reg2Param = RegParam.None,
                                  Function = CommandID.DEC },
            ...
            new OpcodeEncoding { Name = "EX",	// E3: EX (SP) HL
                                  ...
                                  Reg1 = CommandID.SP, Reg1Param = RegParam.Reference | RegParam.WordData,
                                  Reg2 = CommandID.HX, Reg2Param = RegParam.WordData,
                                  Function = CommandID.EX },
            new OpcodeEncoding { Name = "EX",	// 8: EX AF AF
                                  Encoding = new byte[] { 0x08 },
                                  Reg1 = CommandID.AF, Reg1Param = RegParam.WordData,
                                  Reg2 = CommandID.AF, Reg2Param = RegParam.WordData,
                                  Function = CommandID.EX },
            ...
            new OpcodeEncoding { Name = "LD",	// 2: LD (BC) A
                                  ...
                                  Reg1 = CommandID.BC, Reg1Param = RegParam.Reference,
                                  Reg2 = CommandID.A, Reg2Param = RegParam.None,
                                  Function = CommandID.LD },
            new OpcodeEncoding { Name = "LD",	// 12: LD (DE) A
                                  Encoding = new byte[] { 0x12 },
                                  Reg1 = CommandID.DE, Reg1Param = RegParam.Reference,
                                  Reg2 = CommandID.A, Reg2Param = RegParam.None,
                                  Function = CommandID.LD },
            ...
            new OpcodeEncoding { Name = "LD",	// 32: LD (nn) A
                                  ...
                                  Reg1 = CommandID.ImmediateWord, Reg1Param = RegParam.Reference,
                                  Reg2 = CommandID.A, Reg2Param = RegParam.None,
                                  Function = CommandID.LD },
            new OpcodeEncoding { Name = "LD",	// ED43: LD (nn) BC
                                  Encoding = new byte[] { 0xED, 0x43 },
                                  Reg1 = CommandID.ImmediateWord, Reg1Param = RegParam.Reference | RegParam.WordData,
                                  Reg2 = CommandID.BC, Reg2Param = RegParam.WordData,
                                  Function = CommandID.LD },
            ...
            new OpcodeEncoding { Name = "LD",	// 0A: LD A (BC)
                                  ...
                                  Reg1 = CommandID.A, Reg1Param = RegParam.None,
                                  Reg2 = CommandID.BC, Reg2Param = RegParam.Reference,
                                  Function = CommandID.LD },
            new OpcodeEncoding { Name = "LD",	// 1A: LD A (DE)
                                  Encoding = new byte[] { 0x1A },
                                  Reg1 = CommandID.A, Reg1Param = RegParam.None,
                                  Reg2 = CommandID.DE, Reg2Param = RegParam.Reference,
                                  Function = CommandID.LD },
            ...
            new OpcodeEncoding { Name = "LD",	// 3A: LD A (nn)
                                  ...
                                  Reg1 = CommandID.A, Reg1Param = RegParam.None,
                                  Reg2 = CommandID.ImmediateWord, Reg2Param = RegParam.Reference,
                                  Function = CommandID.LD },
            ...
            new OpcodeEncoding { Name = "LD",	// ED57: LD A I
                                  ...
                                  Reg1 = CommandID.A, Reg1Param = RegParam.None,
                                  Reg2 = CommandID.I, Reg2Param = RegParam.None,
                                  Function = CommandID.LD },
            ...
            new OpcodeEncoding { Name = "LD",	// ED5F: LD A R
                                  ...
                                  Reg1 = CommandID.A, Reg1Param = RegParam.None,
                                  Reg2 = CommandID.R, Reg2Param = RegParam.None,
                                  Function = CommandID.LD },
            ...
            new OpcodeEncoding { Name = "LD",	// ED4B: LD BC (nn)
                                  ...
                                  Reg1 = CommandID.BC, Reg1Param = RegParam.WordData,
                                  Reg2 = CommandID.ImmediateWord, Reg2Param = RegParam.Reference | RegParam.WordData,
                                  Function = CommandID.LD },
            ...
            new OpcodeEncoding { Name = "LD",	// ED47: LD I A
                                  ...
                                  Reg1 = CommandID.I, Reg1Param = RegParam.None,
                                  Reg2 = CommandID.A, Reg2Param = RegParam.None,
                                  Function = CommandID.LD },
            ...
            new OpcodeEncoding { Name = "LD",	// ED4F: LD R A
                                  ...
                                  Reg1 = CommandID.R, Reg1Param = RegParam.None,
                                  Reg2 = CommandID.A, Reg2Param = RegParam.None,
                                  Function = CommandID.LD },
