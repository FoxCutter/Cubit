namespace z80
{
    OpcodeEntry MainOpcodes[0x100] =
    {
		...
		{ L"INX", Function::INC, Addressing::WordReg_BC, Addressing::None, 6, 0, 0, }, // 03: INX B
		{ L"INR", Function::INC, Addressing::ByteReg_B, Addressing::None, 4, 0, 0, }, // 04: INR B
		{ L"DCR", Function::DEC, Addressing::ByteReg_B, Addressing::None, 4, 0, 0, }, // 05: DCR B
		...
		{ L"DSUB", Function::SUB, Addressing::WordReg_HL, Addressing::WordReg_BC, 10, 0, 0, }, // 08: *DSUB |H, |B
		...
		{ L"DCX", Function::DEC, Addressing::WordReg_BC, Addressing::None, 6, 0, 0, }, // 0B: DCX B
		{ L"INR", Function::INC, Addressing::ByteReg_C, Addressing::None, 4, 0, 0, }, // 0C: INR C
		{ L"DCR", Function::DEC, Addressing::ByteReg_C, Addressing::None, 4, 0, 0, }, // 0D: DCR C
		...
		{ L"ARHL", Function::SR_SIGNED, Addressing::WordReg_HL, Addressing::None, 7, 0, 0, }, // 10: *ARHL |H
		...
		{ L"INX", Function::INC, Addressing::WordReg_DE, Addressing::None, 6, 0, 0, }, // 13: INX D
		{ L"INR", Function::INC, Addressing::ByteReg_D, Addressing::None, 4, 0, 0, }, // 14: INR D
		{ L"DCR", Function::DEC, Addressing::ByteReg_D, Addressing::None, 4, 0, 0, }, // 15: DCR D
		...
		{ L"RDLE", Function::RL_CY, Addressing::WordReg_DE, Addressing::None, 10, 0, 0, }, // 18: *RDLE |D
		...
		{ L"DCX", Function::DEC, Addressing::WordReg_DE, Addressing::None, 6, 0, 0, }, // 1B: DCX D
		{ L"INR", Function::INC, Addressing::ByteReg_E, Addressing::None, 4, 0, 0, }, // 1C: INR E
		{ L"DCR", Function::DEC, Addressing::ByteReg_E, Addressing::None, 4, 0, 0, }, // 1D: DCR E
		...
		{ L"RIM", Function::RIM, Addressing::ByteReg_A, Addressing::None, 4, 0, 0, }, // 20: RIM |A
		...
		{ L"INX", Function::INC, Addressing::WordReg_HL, Addressing::None, 6, 0, 0, }, // 23: INX H
		{ L"INR", Function::INC, Addressing::ByteReg_H, Addressing::None, 4, 0, 0, }, // 24: INR H
		{ L"DCR", Function::DEC, Addressing::ByteReg_H, Addressing::None, 4, 0, 0, }, // 25: DCR H
		...
		{ L"LDHI", Function::ADD, Addressing::WordReg_DE, Addressing::WordReg_HL, Addressing::ImmediateByte, 10, 0, 0, }, // 28nn: *LDHI |D, |H, nn
		...
		{ L"DCX", Function::DEC, Addressing::WordReg_HL, Addressing::None, 6, 0, 0, }, // 2B: DCX H
		{ L"INR", Function::INC, Addressing::ByteReg_L, Addressing::None, 4, 0, 0, }, // 2C: INR L
		{ L"DCR", Function::DEC, Addressing::ByteReg_L, Addressing::None, 4, 0, 0, }, // 2D: DCR L
		...
		{ L"SIM", Function::SIM, Addressing::ByteReg_A, Addressing::None, 4, 0, 0, }, // 30: SIM |A
		...
		{ L"INX", Function::INC, Addressing::WordReg_SP, Addressing::None, 6, 0, 0, }, // 33: INX SP
		...
		{ L"LDSI", Function::ADD, Addressing::WordReg_DE, Addressing::WordReg_SP, Addressing::ImmediateByte, 10, 0, 0, }, // 38nn: *LDSI |D, |SP, nn
		...
		{ L"DCX", Function::DEC, Addressing::WordReg_SP, Addressing::None, 6, 0, 0, }, // 3B: DCX SP
		{ L"INR", Function::INC, Addressing::ByteReg_A, Addressing::None, 4, 0, 0, }, // 3C: INR A
		{ L"DCR", Function::DEC, Addressing::ByteReg_A, Addressing::None, 4, 0, 0, }, // 3D: DCR A
		...
		{ L"MOV", Function::LOAD, Addressing::ByteReg_B, Addressing::ByteReg_B, 4, 0, 0, }, // 40: MOV B, B
		{ L"MOV", Function::LOAD, Addressing::ByteReg_B, Addressing::ByteReg_C, 4, 0, 0, }, // 41: MOV B, C
		{ L"MOV", Function::LOAD, Addressing::ByteReg_B, Addressing::ByteReg_D, 4, 0, 0, }, // 42: MOV B, D
		{ L"MOV", Function::LOAD, Addressing::ByteReg_B, Addressing::ByteReg_E, 4, 0, 0, }, // 43: MOV B, E
		{ L"MOV", Function::LOAD, Addressing::ByteReg_B, Addressing::ByteReg_H, 4, 0, 0, }, // 44: MOV B, H
		{ L"MOV", Function::LOAD, Addressing::ByteReg_B, Addressing::ByteReg_L, 4, 0, 0, }, // 45: MOV B, L
		{ L"MOV", Function::LOAD, Addressing::ByteReg_B, Addressing::ByteReg_M, 7, 0, 0, }, // 46: MOV B, M
		{ L"MOV", Function::LOAD, Addressing::ByteReg_B, Addressing::ByteReg_A, 4, 0, 0, }, // 47: MOV B, A
		{ L"MOV", Function::LOAD, Addressing::ByteReg_C, Addressing::ByteReg_B, 4, 0, 0, }, // 48: MOV C, B
		{ L"MOV", Function::LOAD, Addressing::ByteReg_C, Addressing::ByteReg_C, 4, 0, 0, }, // 49: MOV C, C
		{ L"MOV", Function::LOAD, Addressing::ByteReg_C, Addressing::ByteReg_D, 4, 0, 0, }, // 4A: MOV C, D
		{ L"MOV", Function::LOAD, Addressing::ByteReg_C, Addressing::ByteReg_E, 4, 0, 0, }, // 4B: MOV C, E
		{ L"MOV", Function::LOAD, Addressing::ByteReg_C, Addressing::ByteReg_H, 4, 0, 0, }, // 4C: MOV C, H
		{ L"MOV", Function::LOAD, Addressing::ByteReg_C, Addressing::ByteReg_L, 4, 0, 0, }, // 4D: MOV C, L
		{ L"MOV", Function::LOAD, Addressing::ByteReg_C, Addressing::ByteReg_M, 7, 0, 0, }, // 4E: MOV C, M
		{ L"MOV", Function::LOAD, Addressing::ByteReg_C, Addressing::ByteReg_A, 4, 0, 0, }, // 4F: MOV C, A
		{ L"MOV", Function::LOAD, Addressing::ByteReg_D, Addressing::ByteReg_B, 4, 0, 0, }, // 50: MOV D, B
		{ L"MOV", Function::LOAD, Addressing::ByteReg_D, Addressing::ByteReg_C, 4, 0, 0, }, // 51: MOV D, C
		{ L"MOV", Function::LOAD, Addressing::ByteReg_D, Addressing::ByteReg_D, 4, 0, 0, }, // 52: MOV D, D
		{ L"MOV", Function::LOAD, Addressing::ByteReg_D, Addressing::ByteReg_E, 4, 0, 0, }, // 53: MOV D, E
		{ L"MOV", Function::LOAD, Addressing::ByteReg_D, Addressing::ByteReg_H, 4, 0, 0, }, // 54: MOV D, H
		{ L"MOV", Function::LOAD, Addressing::ByteReg_D, Addressing::ByteReg_L, 4, 0, 0, }, // 55: MOV D, L
		{ L"MOV", Function::LOAD, Addressing::ByteReg_D, Addressing::ByteReg_M, 7, 0, 0, }, // 56: MOV D, M
		{ L"MOV", Function::LOAD, Addressing::ByteReg_D, Addressing::ByteReg_A, 4, 0, 0, }, // 57: MOV D, A
		{ L"MOV", Function::LOAD, Addressing::ByteReg_E, Addressing::ByteReg_B, 4, 0, 0, }, // 58: MOV E, B
		{ L"MOV", Function::LOAD, Addressing::ByteReg_E, Addressing::ByteReg_C, 4, 0, 0, }, // 59: MOV E, C
		{ L"MOV", Function::LOAD, Addressing::ByteReg_E, Addressing::ByteReg_D, 4, 0, 0, }, // 5A: MOV E, D
		{ L"MOV", Function::LOAD, Addressing::ByteReg_E, Addressing::ByteReg_E, 4, 0, 0, }, // 5B: MOV E, E
		{ L"MOV", Function::LOAD, Addressing::ByteReg_E, Addressing::ByteReg_H, 4, 0, 0, }, // 5C: MOV E, H
		{ L"MOV", Function::LOAD, Addressing::ByteReg_E, Addressing::ByteReg_L, 4, 0, 0, }, // 5D: MOV E, L
		{ L"MOV", Function::LOAD, Addressing::ByteReg_E, Addressing::ByteReg_M, 7, 0, 0, }, // 5E: MOV E, M
		{ L"MOV", Function::LOAD, Addressing::ByteReg_E, Addressing::ByteReg_A, 4, 0, 0, }, // 5F: MOV E, A
		{ L"MOV", Function::LOAD, Addressing::ByteReg_H, Addressing::ByteReg_B, 4, 0, 0, }, // 60: MOV H, B
		{ L"MOV", Function::LOAD, Addressing::ByteReg_H, Addressing::ByteReg_C, 4, 0, 0, }, // 61: MOV H, C
		{ L"MOV", Function::LOAD, Addressing::ByteReg_H, Addressing::ByteReg_D, 4, 0, 0, }, // 62: MOV H, D
		{ L"MOV", Function::LOAD, Addressing::ByteReg_H, Addressing::ByteReg_E, 4, 0, 0, }, // 63: MOV H, E
		{ L"MOV", Function::LOAD, Addressing::ByteReg_H, Addressing::ByteReg_H, 4, 0, 0, }, // 64: MOV H, H
		{ L"MOV", Function::LOAD, Addressing::ByteReg_H, Addressing::ByteReg_L, 4, 0, 0, }, // 65: MOV H, L
		{ L"MOV", Function::LOAD, Addressing::ByteReg_H, Addressing::ByteReg_M, 7, 0, 0, }, // 66: MOV H, M
		{ L"MOV", Function::LOAD, Addressing::ByteReg_H, Addressing::ByteReg_A, 4, 0, 0, }, // 67: MOV H, A
		{ L"MOV", Function::LOAD, Addressing::ByteReg_L, Addressing::ByteReg_B, 4, 0, 0, }, // 68: MOV L, B
		{ L"MOV", Function::LOAD, Addressing::ByteReg_L, Addressing::ByteReg_C, 4, 0, 0, }, // 69: MOV L, C
		{ L"MOV", Function::LOAD, Addressing::ByteReg_L, Addressing::ByteReg_D, 4, 0, 0, }, // 6A: MOV L, D
		{ L"MOV", Function::LOAD, Addressing::ByteReg_L, Addressing::ByteReg_E, 4, 0, 0, }, // 6B: MOV L, E
		{ L"MOV", Function::LOAD, Addressing::ByteReg_L, Addressing::ByteReg_H, 4, 0, 0, }, // 6C: MOV L, H
		{ L"MOV", Function::LOAD, Addressing::ByteReg_L, Addressing::ByteReg_L, 4, 0, 0, }, // 6D: MOV L, L
		{ L"MOV", Function::LOAD, Addressing::ByteReg_L, Addressing::ByteReg_M, 7, 0, 0, }, // 6E: MOV L, M
		{ L"MOV", Function::LOAD, Addressing::ByteReg_L, Addressing::ByteReg_A, 4, 0, 0, }, // 6F: MOV L, A
		...
		{ L"HLT", Function::HALT, Addressing::None, Addressing::None, 5, 0, 0, }, // 76: HLT
		{ L"MOV", Function::LOAD, Addressing::ByteReg_M, Addressing::ByteReg_A, 7, 0, 0, }, // 77: MOV M, A
		{ L"MOV", Function::LOAD, Addressing::ByteReg_A, Addressing::ByteReg_B, 4, 0, 0, }, // 78: MOV A, B
		{ L"MOV", Function::LOAD, Addressing::ByteReg_A, Addressing::ByteReg_C, 4, 0, 0, }, // 79: MOV A, C
		{ L"MOV", Function::LOAD, Addressing::ByteReg_A, Addressing::ByteReg_D, 4, 0, 0, }, // 7A: MOV A, D
		{ L"MOV", Function::LOAD, Addressing::ByteReg_A, Addressing::ByteReg_E, 4, 0, 0, }, // 7B: MOV A, E
		{ L"MOV", Function::LOAD, Addressing::ByteReg_A, Addressing::ByteReg_H, 4, 0, 0, }, // 7C: MOV A, H
		{ L"MOV", Function::LOAD, Addressing::ByteReg_A, Addressing::ByteReg_L, 4, 0, 0, }, // 7D: MOV A, L
		{ L"MOV", Function::LOAD, Addressing::ByteReg_A, Addressing::ByteReg_M, 7, 0, 0, }, // 7E: MOV A, M
		{ L"MOV", Function::LOAD, Addressing::ByteReg_A, Addressing::ByteReg_A, 4, 0, 0, }, // 7F: MOV A, A
		...
		{ L"RNZ", Function::RET, Addressing::#Flag_NZ, Addressing::None, 6, 12, 0, }, // C0: RNZ |NZ
		{ L"POP", Function::POP, Addressing::WordReg_BC, Addressing::None, 10, 0, 0, }, // C1: POP B
		{ L"JNZ", Function::JMP, Addressing::#Flag_NZ, Addressing::Address, 7, 10, 0, }, // C2nnnn: JNZ |NZ, nnnn
		{ L"JMP", Function::JMP, Addressing::Address, Addressing::None, 10, 0, 0, }, // C3nnnn: JMP nnnn
		{ L"CNZ", Function::CALL, Addressing::#Flag_NZ, Addressing::Address, 9, 18, 0, }, // C4nnnn: CNZ |NZ, nnnn
		{ L"PUSH", Function::PUSH, Addressing::WordReg_BC, Addressing::None, 12, 0, 0, }, // C5: PUSH B
		{ L"ADI", Function::ADD, Addressing::ByteReg_A, Addressing::ImmediateByte, 7, 0, 0, }, // C6nn: ADI |A, nn
		{ L"RST", Function::RST, Addressing::Value0, Addressing::None, 12, 0, 0, }, // C7: RST 0
		{ L"RZ", Function::RET, Addressing::#Flag_Z, Addressing::None, 6, 12, 0, }, // C8: RZ |Z
		{ L"RET", Function::RET, Addressing::None, Addressing::None, 10, 0, 0, }, // C9: RET
		{ L"JZ", Function::JMP, Addressing::#Flag_Z, Addressing::Address, 7, 10, 0, }, // CAnnnn: JZ |Z, nnnn
		{ L"RSTV", Function::RST, Addressing::Value8, Addressing::None, 6, 12, 0, }, // CB: *RSTV |Value8
		{ L"CZ", Function::CALL, Addressing::#Flag_Z, Addressing::Address, 9, 18, 0, }, // CCnnnn: CZ |Z, nnnn
		{ L"CALL", Function::CALL, Addressing::Address, Addressing::None, 18, 0, 0, }, // CDnnnn: CALL nnnn
		{ L"ACI", Function::ADD_CY, Addressing::ByteReg_A, Addressing::ImmediateByte, 7, 0, 0, }, // CEnn: ACI |A, nn
		{ L"RST", Function::RST, Addressing::Value1, Addressing::None, 12, 0, 0, }, // CF: RST 1
		{ L"RNC", Function::RET, Addressing::#Flag_NC, Addressing::None, 6, 12, 0, }, // D0: RNC |NC
		{ L"POP", Function::POP, Addressing::WordReg_DE, Addressing::None, 10, 0, 0, }, // D1: POP D
		{ L"JNC", Function::JMP, Addressing::#Flag_NC, Addressing::Address, 7, 10, 0, }, // D2nnnn: JNC |NC, nnnn
		{ L"OUT", Function::OUT, Addressing::ImmediateByte, Addressing::ByteReg_A, 10, 0, 0, }, // D3nn: OUT nn, |A
		{ L"CNC", Function::CALL, Addressing::#Flag_NC, Addressing::Address, 9, 18, 0, }, // D4nnnn: CNC |NC, nnnn
		{ L"PUSH", Function::PUSH, Addressing::WordReg_DE, Addressing::None, 12, 0, 0, }, // D5: PUSH D
		{ L"SUI", Function::SUB, Addressing::ByteReg_A, Addressing::ImmediateByte, 7, 0, 0, }, // D6nn: SUI |A, nn
		{ L"RST", Function::RST, Addressing::Value2, Addressing::None, 12, 0, 0, }, // D7: RST 2
		{ L"RC", Function::RET, Addressing::#Flag_CY, Addressing::None, 6, 12, 0, }, // D8: RC |CY
		{ L"SHLX", Function::LOAD, Addressing::WordReg_DE, Addressing::WordReg_HL, 10, 0, 0, }, // D9: *SHLX |D, |H
		{ L"JC", Function::JMP, Addressing::#Flag_CY, Addressing::Address, 7, 10, 0, }, // DAnnnn: JC |CY, nnnn
		{ L"IN", Function::IN, Addressing::ByteReg_A, Addressing::ImmediateByte, 10, 0, 0, }, // DBnn: IN |A, nn
		{ L"CC", Function::CALL, Addressing::#Flag_CY, Addressing::Address, 9, 18, 0, }, // DCnnnn: CC |CY, nnnn
		{ L"JNK", Function::JMP, Addressing::#Flag_NK, Addressing::Address, 7, 10, 0, }, // DDnnnn: *JNK |NK, nnnn
		{ L"SBI", Function::SUB_CY, Addressing::ByteReg_A, Addressing::ImmediateByte, 7, 0, 0, }, // DEnn: SBI |A, nn
		{ L"RST", Function::RST, Addressing::Value3, Addressing::None, 12, 0, 0, }, // DF: RST 3
		{ L"RPO", Function::RET, Addressing::#Flag_PO, Addressing::None, 6, 12, 0, }, // E0: RPO |PO
		{ L"POP", Function::POP, Addressing::WordReg_HL, Addressing::None, 10, 0, 0, }, // E1: POP H
		{ L"JPO", Function::JMP, Addressing::#Flag_PO, Addressing::Address, 7, 10, 0, }, // E2nnnn: JPO |PO, nnnn
		{ L"XTHL", Function::EX, Addressing::WordReg_SPRef, Addressing::WordReg_HL, 5, 0, 0, }, // E3: XTHL |(SP), |H
		{ L"CPO", Function::CALL, Addressing::#Flag_PO, Addressing::Address, 9, 18, 0, }, // E4nnnn: CPO |PO, nnnn
		{ L"PUSH", Function::PUSH, Addressing::WordReg_HL, Addressing::None, 12, 0, 0, }, // E5: PUSH H
		{ L"ANI", Function::AND, Addressing::ByteReg_A, Addressing::ImmediateByte, 7, 0, 0, }, // E6nn: ANI |A, nn
		{ L"RST", Function::RST, Addressing::Value4, Addressing::None, 12, 0, 0, }, // E7: RST 4
		{ L"RPE", Function::RET, Addressing::#Flag_PE, Addressing::None, 6, 12, 0, }, // E8: RPE |PE
		{ L"PCHL", Function::JMP, Addressing::WordReg_HL, Addressing::None, 6, 0, 0, }, // E9: PCHL |H
		{ L"JPE", Function::JMP, Addressing::#Flag_PE, Addressing::Address, 7, 10, 0, }, // EAnnnn: JPE |PE, nnnn
		{ L"XCHG", Function::EX, Addressing::WordReg_DE, Addressing::WordReg_HL, 4, 0, 0, }, // EB: XCHG |D, |H
		{ L"CPE", Function::CALL, Addressing::#Flag_PE, Addressing::Address, 9, 18, 0, }, // ECnnnn: CPE |PE, nnnn
		{ L"LHLX", Function::LOAD, Addressing::WordReg_HL, Addressing::WordReg_DE, 10, 0, 0, }, // ED: *LHLX |H, |D
		{ L"XRI", Function::XOR, Addressing::ByteReg_A, Addressing::ImmediateByte, 7, 0, 0, }, // EEnn: XRI |A, nn
		{ L"RST", Function::RST, Addressing::Value5, Addressing::None, 12, 0, 0, }, // EF: RST 5
		{ L"RP", Function::RET, Addressing::#Flag_P, Addressing::None, 6, 12, 0, }, // F0: RP |P
		{ L"POP", Function::POP, Addressing::WordReg_PSW, Addressing::None, 10, 0, 0, }, // F1: POP PSW
		{ L"JP", Function::JMP, Addressing::#Flag_P, Addressing::Address, 7, 10, 0, }, // F2nnnn: JP |P, nnnn
		{ L"DI", Function::DI, Addressing::None, Addressing::None, 4, 0, 0, }, // F3: DI
		{ L"CP", Function::CALL, Addressing::#Flag_P, Addressing::Address, 9, 18, 0, }, // F4nnnn: CP |P, nnnn
		{ L"PUSH", Function::PUSH, Addressing::WordReg_PSW, Addressing::None, 12, 0, 0, }, // F5: PUSH PSW
		{ L"ORI", Function::OR, Addressing::ByteReg_A, Addressing::ImmediateByte, 7, 0, 0, }, // F6nn: ORI |A, nn
		{ L"RST", Function::RST, Addressing::Value6, Addressing::None, 12, 0, 0, }, // F7: RST 6
		{ L"RM", Function::RET, Addressing::#Flag_M, Addressing::None, 6, 12, 0, }, // F8: RM |M
		{ L"SPHL", Function::LOAD, Addressing::WordReg_SP, Addressing::WordReg_HL, 6, 0, 0, }, // F9: SPHL |SP, |H
		{ L"JM", Function::JMP, Addressing::#Flag_M, Addressing::Address, 7, 10, 0, }, // FAnnnn: JM |M, nnnn
		{ L"EI", Function::EI, Addressing::None, Addressing::None, 4, 0, 0, }, // FB: EI
		{ L"CM", Function::CALL, Addressing::#Flag_M, Addressing::Address, 9, 18, 0, }, // FCnnnn: CM |M, nnnn
		{ L"JK", Function::JMP, Addressing::#Flag_K, Addressing::Address, 7, 10, 0, }, // FDnnnn: *JK |K, nnnn
		{ L"CPI", Function::CMP, Addressing::ByteReg_A, Addressing::ImmediateByte, 7, 0, 0, }, // FEnn: CPI |A, nn
		{ L"RST", Function::RST, Addressing::Value7, Addressing::None, 12, 0, 0, }, // FF: RST 7
    };
