namespace z80
{
    OpcodeEntry MainOpcodes[0x100] =
    {
		...
		{ L"RSTV", Function::RST, Addressing::Value8, Addressing::None, 5, 12, 0, }, // CB: *RSTV |Value8
		...
		{ L"JNK", Function::JMP, Addressing::#Flag_NK, Addressing::Address, 10, 10, 0, }, // DDnnnn: *JNK |NK, nnnn
		...
		{ L"LHLX", Function::LOAD, Addressing::WordReg_HL, Addressing::WordReg_DE, 17, 0, 0, }, // ED: *LHLX |H, |D
		...
		{ L"JK", Function::JMP, Addressing::#Flag_K, Addressing::Address, 10, 17, 0, }, // FDnnnn: *JK |K, nnnn
