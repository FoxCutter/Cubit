...
namespace OpcodeData
{
    public static partial class ZASM
    {
        public static OpcodeEntry[] i8080OpcodeList = new OpcodeEntry[]
        {
            ...
            new OpcodeEntry { Index = false, Prefix = 0x00, Encoding = 0x8E, Name = CommandID.ADC , Function = FunctionID.ADD_C, Params = new ParamEntry[] { new ParamEntry(ParameterID.HL, ParameterType.WordRegisterPointer, EncodingType.None, false), }, Type = OpcodeType.Official, Cycles = 6, Length = 1, }, // 8E: ADC M
            ...
            new OpcodeEntry { Index = false, Prefix = 0x00, Encoding = 0x86, Name = CommandID.ADD , Function = FunctionID.ADD, Params = new ParamEntry[] { new ParamEntry(ParameterID.HL, ParameterType.WordRegisterPointer, EncodingType.None, false), }, Type = OpcodeType.Official, Cycles = 6, Length = 1, }, // 86: ADD M
            ...
            new OpcodeEntry { Index = false, Prefix = 0x00, Encoding = 0x96, Name = CommandID.SUB , Function = FunctionID.SUB, Params = new ParamEntry[] { new ParamEntry(ParameterID.HL, ParameterType.WordRegisterPointer, EncodingType.None, false), }, Type = OpcodeType.Official, Cycles = 6, Length = 1, }, // 96: SUB M
            ...
            new OpcodeEntry { Index = false, Prefix = 0x00, Encoding = 0xA6, Name = CommandID.ANA , Function = FunctionID.AND, Params = new ParamEntry[] { new ParamEntry(ParameterID.HL, ParameterType.WordRegisterPointer, EncodingType.None, false), }, Type = OpcodeType.Official, Cycles = 6, Length = 1, }, // A6: ANA M
            ...
            new OpcodeEntry { Index = false, Prefix = 0x00, Encoding = 0xBE, Name = CommandID.CMP , Function = FunctionID.CMP, Params = new ParamEntry[] { new ParamEntry(ParameterID.HL, ParameterType.WordRegisterPointer, EncodingType.None, false), }, Type = OpcodeType.Official, Cycles = 6, Length = 1, }, // BE: CMP M
            ...
            new OpcodeEntry { Index = false, Prefix = 0x00, Encoding = 0x35, Name = CommandID.DCR , Function = FunctionID.DEC, Params = new ParamEntry[] { new ParamEntry(ParameterID.HL, ParameterType.WordRegisterPointer, EncodingType.None, false), }, Type = OpcodeType.Official, Cycles = 10, Length = 1, }, // 35: DCR M
            ...
            new OpcodeEntry { Index = false, Prefix = 0x00, Encoding = 0x34, Name = CommandID.INR , Function = FunctionID.INC, Params = new ParamEntry[] { new ParamEntry(ParameterID.HL, ParameterType.WordRegisterPointer, EncodingType.None, false), }, Type = OpcodeType.Official, Cycles = 10, Length = 1, }, // 34: INR M
            ...
            new OpcodeEntry { Index = false, Prefix = 0x00, Encoding = 0x0A, Name = CommandID.LDAX, Function = FunctionID.LD, Params = new ParamEntry[] { new ParamEntry(ParameterID.BC, ParameterType.WordRegisterPointer, EncodingType.None, false), }, Type = OpcodeType.Official, Cycles = 7, Length = 1, }, // 0A: LDAX B
            new OpcodeEntry { Index = false, Prefix = 0x00, Encoding = 0x1A, Name = CommandID.LDAX, Function = FunctionID.LD, Params = new ParamEntry[] { new ParamEntry(ParameterID.DE, ParameterType.WordRegisterPointer, EncodingType.None, false), }, Type = OpcodeType.Official, Cycles = 7, Length = 1, }, // 1A: LDAX D
            ...
            new OpcodeEntry { Index = false, Prefix = 0x00, Encoding = 0xB6, Name = CommandID.ORA , Function = FunctionID.OR, Params = new ParamEntry[] { new ParamEntry(ParameterID.HL, ParameterType.WordRegisterPointer, EncodingType.None, false), }, Type = OpcodeType.Official, Cycles = 6, Length = 1, }, // B6: ORA M
            ...
            new OpcodeEntry { Index = false, Prefix = 0x00, Encoding = 0x9E, Name = CommandID.SBB , Function = FunctionID.SUB_C, Params = new ParamEntry[] { new ParamEntry(ParameterID.HL, ParameterType.WordRegisterPointer, EncodingType.None, false), }, Type = OpcodeType.Official, Cycles = 6, Length = 1, }, // 9E: SBB M
            ...
            new OpcodeEntry { Index = false, Prefix = 0x00, Encoding = 0x02, Name = CommandID.STAX, Function = FunctionID.LD, Params = new ParamEntry[] { new ParamEntry(ParameterID.BC, ParameterType.WordRegisterPointer, EncodingType.None, false), }, Type = OpcodeType.Official, Cycles = 7, Length = 1, }, // 02: STAX B
            new OpcodeEntry { Index = false, Prefix = 0x00, Encoding = 0x12, Name = CommandID.STAX, Function = FunctionID.LD, Params = new ParamEntry[] { new ParamEntry(ParameterID.DE, ParameterType.WordRegisterPointer, EncodingType.None, false), }, Type = OpcodeType.Official, Cycles = 7, Length = 1, }, // 12: STAX D
            ...
            new OpcodeEntry { Index = false, Prefix = 0x00, Encoding = 0xAE, Name = CommandID.XRA , Function = FunctionID.XOR, Params = new ParamEntry[] { new ParamEntry(ParameterID.HL, ParameterType.WordRegisterPointer, EncodingType.None, false), }, Type = OpcodeType.Official, Cycles = 6, Length = 1, }, // AE: XRA M
