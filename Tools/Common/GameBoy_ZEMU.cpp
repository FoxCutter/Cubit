namespace z80
{
    OpcodeEntry MainOpcodes[0x100] =
    {
		...
		{ L"ADD", Function::ADD, Addressing::WordReg_HL, Addressing::WordReg_BC, 11, 0, 0, }, // 09: ADD HL, BC
		...
		{ L"ADD", Function::ADD, Addressing::WordReg_HL, Addressing::WordReg_DE, 11, 0, 0, }, // 19: ADD HL, DE
		...
		{ L"LD", Function::LOAD, Addressing::WordReg_HL, Addressing::ImmediateWord, 10, 0, 0, }, // 21nnnn: LD HL, nnnn
		{ L"LD", Function::LOAD_INC, Addressing::WordReg_HLIRef, Addressing::ByteReg_A, 12, 0, 0, }, // 22: LD (HLI), A
		{ L"INC", Function::INC, Addressing::WordReg_HL, Addressing::None, 6, 0, 0, }, // 23: INC HL
		...
		{ L"LD", Function::LOAD, Addressing::ByteReg_H, Addressing::ImmediateByte, 7, 0, 0, }, // 26nn: LD H, nn
		...
		{ L"ADD", Function::ADD, Addressing::WordReg_HL, Addressing::WordReg_HL, 11, 0, 0, }, // 29: ADD HL, HL
		{ L"LD", Function::LOAD_INC, Addressing::ByteReg_A, Addressing::WordReg_HLIRef, 12, 0, 0, }, // 2A: LD A, (HLI)
		{ L"DEC", Function::DEC, Addressing::WordReg_HL, Addressing::None, 6, 0, 0, }, // 2B: DEC HL
		...
		{ L"LD", Function::LOAD, Addressing::ByteReg_L, Addressing::ImmediateByte, 7, 0, 0, }, // 2Enn: LD L, nn
		...
		{ L"LD", Function::LOAD_DEC, Addressing::WordReg_HLDRef, Addressing::ByteReg_A, 12, 0, 0, }, // 32: LD (HLD), A
		{ L"INC", Function::INC, Addressing::WordReg_SP, Addressing::None, 6, 0, 0, }, // 33: INC SP
		{ L"INC", Function::INC, Addressing::WordReg_HLRef, Addressing::None, 11, 0, 0, }, // 34: INC (HL)
		{ L"DEC", Function::DEC, Addressing::WordReg_HLRef, Addressing::None, 11, 0, 0, }, // 35: DEC (HL)
		{ L"LD", Function::LOAD, Addressing::WordReg_HLRef, Addressing::ImmediateByte, 10, 0, 0, }, // 36nn: LD (HL), nn
		...
		{ L"ADD", Function::ADD, Addressing::WordReg_HL, Addressing::WordReg_SP, 11, 0, 0, }, // 39: ADD HL, SP
		...
		{ L"LD", Function::LOAD, Addressing::ByteReg_B, Addressing::WordReg_HLRef, 7, 0, 0, }, // 46: LD B, (HL)
		...
		{ L"LD", Function::LOAD, Addressing::ByteReg_C, Addressing::WordReg_HLRef, 7, 0, 0, }, // 4E: LD C, (HL)
		...
		{ L"LD", Function::LOAD, Addressing::ByteReg_D, Addressing::WordReg_HLRef, 7, 0, 0, }, // 56: LD D, (HL)
		...
		{ L"LD", Function::LOAD, Addressing::ByteReg_E, Addressing::WordReg_HLRef, 7, 0, 0, }, // 5E: LD E, (HL)
		...
		{ L"LD", Function::LOAD, Addressing::ByteReg_H, Addressing::WordReg_HLRef, 7, 0, 0, }, // 66: LD H, (HL)
		...
		{ L"LD", Function::LOAD, Addressing::ByteReg_L, Addressing::WordReg_HLRef, 7, 0, 0, }, // 6E: LD L, (HL)
		{ L"LD", Function::LOAD, Addressing::ByteReg_L, Addressing::ByteReg_A, 4, 0, 0, }, // 6F: LD L, A
		{ L"LD", Function::LOAD, Addressing::WordReg_HLRef, Addressing::ByteReg_B, 7, 0, 0, }, // 70: LD (HL), B
		{ L"LD", Function::LOAD, Addressing::WordReg_HLRef, Addressing::ByteReg_C, 7, 0, 0, }, // 71: LD (HL), C
		{ L"LD", Function::LOAD, Addressing::WordReg_HLRef, Addressing::ByteReg_D, 7, 0, 0, }, // 72: LD (HL), D
		{ L"LD", Function::LOAD, Addressing::WordReg_HLRef, Addressing::ByteReg_E, 7, 0, 0, }, // 73: LD (HL), E
		{ L"LD", Function::LOAD, Addressing::WordReg_HLRef, Addressing::ByteReg_H, 7, 0, 0, }, // 74: LD (HL), H
		{ L"LD", Function::LOAD, Addressing::WordReg_HLRef, Addressing::ByteReg_L, 7, 0, 0, }, // 75: LD (HL), L
		{ L"HALT", Function::HALT, Addressing::None, Addressing::None, 4, 0, 0, }, // 76: HALT
		{ L"LD", Function::LOAD, Addressing::WordReg_HLRef, Addressing::ByteReg_A, 7, 0, 0, }, // 77: LD (HL), A
		...
		{ L"LD", Function::LOAD, Addressing::ByteReg_A, Addressing::WordReg_HLRef, 7, 0, 0, }, // 7E: LD A, (HL)
		...
		{ L"ADD", Function::ADD, Addressing::ByteReg_A, Addressing::WordReg_HLRef, 7, 0, 0, }, // 86: ADD A, (HL)
		...
		{ L"ADC", Function::ADD_CY, Addressing::ByteReg_A, Addressing::WordReg_HLRef, 7, 0, 0, }, // 8E: ADC A, (HL)
		...
		{ L"SUB", Function::SUB, Addressing::ByteReg_A, Addressing::WordReg_HLRef, 7, 0, 0, }, // 96: SUB |A, (HL)
		...
		{ L"SBC", Function::SUB_CY, Addressing::ByteReg_A, Addressing::WordReg_HLRef, 7, 0, 0, }, // 9E: SBC A, (HL)
		...
		{ L"AND", Function::AND, Addressing::ByteReg_A, Addressing::WordReg_HLRef, 7, 0, 0, }, // A6: AND |A, (HL)
		...
		{ L"XOR", Function::XOR, Addressing::ByteReg_A, Addressing::WordReg_HLRef, 7, 0, 0, }, // AE: XOR A, (HL)
		...
		{ L"OR", Function::OR, Addressing::ByteReg_A, Addressing::WordReg_HLRef, 7, 0, 0, }, // B6: OR |A, (HL)
		...
		{ L"CP", Function::CMP, Addressing::ByteReg_A, Addressing::WordReg_HLRef, 7, 0, 0, }, // BE: CP |A, (HL)
		...
		{ L"POP", Function::POP, Addressing::WordReg_HL, Addressing::None, 10, 0, 0, }, // E1: POP HL
		...
		{ L"PUSH", Function::PUSH, Addressing::WordReg_HL, Addressing::None, 11, 0, 0, }, // E5: PUSH HL
		...
		{ L"LD", Function::LOAD_HIGH, Addressing::ByteReg_A, Addressing::HighRefPlusByteReg_C, 12, 0, 0, }, // F2: LD A, ($ff00 + C)
		...
		{ L"LD", Function::LOAD, Addressing::WordReg_SP, Addressing::WordReg_HL, 6, 0, 0, }, // F9: LD SP, HL
    ...
    OpcodeEntry BitOpcodes[0x100] =
    {
		...
		{ L"RLC", Function::RL, Addressing::WordReg_HLRef, Addressing::None, 15, 0, 0, }, // CB06: RLC (HL)
		...
		{ L"RRC", Function::RR, Addressing::WordReg_HLRef, Addressing::None, 15, 0, 0, }, // CB0E: RRC (HL)
		{ L"RRC", Function::RR, Addressing::ByteReg_A, Addressing::None, 8, 0, 0, }, // CB0F: RRC A
		{ L"RL", Function::RL_CY, Addressing::ByteReg_B, Addressing::None, 4, 0, 0, }, // CB10: RL B
		{ L"RL", Function::RL_CY, Addressing::ByteReg_C, Addressing::None, 4, 0, 0, }, // CB11: RL C
		{ L"RL", Function::RL_CY, Addressing::ByteReg_D, Addressing::None, 4, 0, 0, }, // CB12: RL D
		{ L"RL", Function::RL_CY, Addressing::ByteReg_E, Addressing::None, 4, 0, 0, }, // CB13: RL E
		{ L"RL", Function::RL_CY, Addressing::ByteReg_H, Addressing::None, 4, 0, 0, }, // CB14: RL H
		{ L"RL", Function::RL_CY, Addressing::ByteReg_L, Addressing::None, 4, 0, 0, }, // CB15: RL L
		{ L"RL", Function::RL_CY, Addressing::WordReg_HLRef, Addressing::None, 23, 0, 0, }, // CB16: RL (HL)
		{ L"RL", Function::RL_CY, Addressing::ByteReg_A, Addressing::None, 4, 0, 0, }, // CB17: RL A
		{ L"RR", Function::RR_CY, Addressing::ByteReg_B, Addressing::None, 4, 0, 0, }, // CB18: RR B
		{ L"RR", Function::RR_CY, Addressing::ByteReg_C, Addressing::None, 4, 0, 0, }, // CB19: RR C
		{ L"RR", Function::RR_CY, Addressing::ByteReg_D, Addressing::None, 4, 0, 0, }, // CB1A: RR D
		{ L"RR", Function::RR_CY, Addressing::ByteReg_E, Addressing::None, 4, 0, 0, }, // CB1B: RR E
		{ L"RR", Function::RR_CY, Addressing::ByteReg_H, Addressing::None, 4, 0, 0, }, // CB1C: RR H
		{ L"RR", Function::RR_CY, Addressing::ByteReg_L, Addressing::None, 4, 0, 0, }, // CB1D: RR L
		{ L"RR", Function::RR_CY, Addressing::WordReg_HLRef, Addressing::None, 15, 0, 0, }, // CB1E: RR (HL)
		{ L"RR", Function::RR_CY, Addressing::ByteReg_A, Addressing::None, 4, 0, 0, }, // CB1F: RR A
		...
		{ L"SLA", Function::SL_SIGNED, Addressing::WordReg_HLRef, Addressing::None, 15, 0, 0, }, // CB26: SLA (HL)
		{ L"SLA", Function::SL_SIGNED, Addressing::ByteReg_A, Addressing::None, 8, 0, 0, }, // CB27: SLA A
		{ L"SRA", Function::SR_SIGNED, Addressing::ByteReg_B, Addressing::None, 4, 0, 0, }, // CB28: SRA B
		{ L"SRA", Function::SR_SIGNED, Addressing::ByteReg_C, Addressing::None, 4, 0, 0, }, // CB29: SRA C
		{ L"SRA", Function::SR_SIGNED, Addressing::ByteReg_D, Addressing::None, 4, 0, 0, }, // CB2A: SRA D
		{ L"SRA", Function::SR_SIGNED, Addressing::ByteReg_E, Addressing::None, 4, 0, 0, }, // CB2B: SRA E
		{ L"SRA", Function::SR_SIGNED, Addressing::ByteReg_H, Addressing::None, 4, 0, 0, }, // CB2C: SRA H
		{ L"SRA", Function::SR_SIGNED, Addressing::ByteReg_L, Addressing::None, 4, 0, 0, }, // CB2D: SRA L
		{ L"SRA", Function::SR_SIGNED, Addressing::WordReg_HLRef, Addressing::None, 15, 0, 0, }, // CB2E: SRA (HL)
		{ L"SRA", Function::SR_SIGNED, Addressing::ByteReg_A, Addressing::None, 4, 0, 0, }, // CB2F: SRA A
		...
		{ L"SRL", Function::SR_L, Addressing::WordReg_HLRef, Addressing::None, 15, 0, 0, }, // CB3E: SRL (HL)
		...
		{ L"BIT", Function::BIT, Addressing::Value0, Addressing::WordReg_HLRef, 12, 0, 0, }, // CB46: BIT 0, (HL)
		...
		{ L"BIT", Function::BIT, Addressing::Value1, Addressing::WordReg_HLRef, 12, 0, 0, }, // CB4E: BIT 1, (HL)
		...
		{ L"BIT", Function::BIT, Addressing::Value2, Addressing::WordReg_HLRef, 12, 0, 0, }, // CB56: BIT 2, (HL)
		...
		{ L"BIT", Function::BIT, Addressing::Value3, Addressing::WordReg_HLRef, 12, 0, 0, }, // CB5E: BIT 3, (HL)
		...
		{ L"BIT", Function::BIT, Addressing::Value4, Addressing::WordReg_HLRef, 12, 0, 0, }, // CB66: BIT 4, (HL)
		...
		{ L"BIT", Function::BIT, Addressing::Value5, Addressing::WordReg_HLRef, 12, 0, 0, }, // CB6E: BIT 5, (HL)
		...
		{ L"BIT", Function::BIT, Addressing::Value6, Addressing::WordReg_HLRef, 12, 0, 0, }, // CB76: BIT 6, (HL)
		...
		{ L"BIT", Function::BIT, Addressing::Value7, Addressing::WordReg_HLRef, 12, 0, 0, }, // CB7E: BIT 7, (HL)
		...
		{ L"RES", Function::RES, Addressing::Value0, Addressing::WordReg_HLRef, 15, 0, 0, }, // CB86: RES 0, (HL)
		...
		{ L"RES", Function::RES, Addressing::Value1, Addressing::WordReg_HLRef, 15, 0, 0, }, // CB8E: RES 1, (HL)
		...
		{ L"RES", Function::RES, Addressing::Value2, Addressing::WordReg_HLRef, 15, 0, 0, }, // CB96: RES 2, (HL)
		...
		{ L"RES", Function::RES, Addressing::Value3, Addressing::WordReg_HLRef, 15, 0, 0, }, // CB9E: RES 3, (HL)
		...
		{ L"RES", Function::RES, Addressing::Value4, Addressing::WordReg_HLRef, 15, 0, 0, }, // CBA6: RES 4, (HL)
		...
		{ L"RES", Function::RES, Addressing::Value5, Addressing::WordReg_HLRef, 15, 0, 0, }, // CBAE: RES 5, (HL)
		...
		{ L"RES", Function::RES, Addressing::Value6, Addressing::WordReg_HLRef, 15, 0, 0, }, // CBB6: RES 6, (HL)
		...
		{ L"RES", Function::RES, Addressing::Value7, Addressing::WordReg_HLRef, 15, 0, 0, }, // CBBE: RES 7, (HL)
		...
		{ L"SET", Function::SET, Addressing::Value0, Addressing::WordReg_HLRef, 15, 0, 0, }, // CBC6: SET 0, (HL)
		...
		{ L"SET", Function::SET, Addressing::Value1, Addressing::WordReg_HLRef, 15, 0, 0, }, // CBCE: SET 1, (HL)
		...
		{ L"SET", Function::SET, Addressing::Value2, Addressing::WordReg_HLRef, 15, 0, 0, }, // CBD6: SET 2, (HL)
		...
		{ L"SET", Function::SET, Addressing::Value3, Addressing::WordReg_HLRef, 15, 0, 0, }, // CBDE: SET 3, (HL)
		...
		{ L"SET", Function::SET, Addressing::Value4, Addressing::WordReg_HLRef, 15, 0, 0, }, // CBE6: SET 4, (HL)
		...
		{ L"SET", Function::SET, Addressing::Value5, Addressing::WordReg_HLRef, 15, 0, 0, }, // CBEE: SET 5, (HL)
		...
		{ L"SET", Function::SET, Addressing::Value6, Addressing::WordReg_HLRef, 15, 0, 0, }, // CBF6: SET 6, (HL)
		...
		{ L"SET", Function::SET, Addressing::Value7, Addressing::WordReg_HLRef, 15, 0, 0, }, // CBFE: SET 7, (HL)
